            ...
            <el-row>
                <el-col :span="10">
                    <el-form-item label="角色名" prop="roleName">
                        <el-input v-model="formData.roleName" auto-complete="off" placeholder="请输入" :disabled="isDisabled"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="10">
                    <el-form-item label="角色权限" prop="">
                        <el-select multiple v-model="formData.rolePermission"  placeholder="请选择"> 
                            <el-option v-for="item in permissionOptions" :key="item.id" :label="item.text" :value="item.id" ></el-option>
                        </el-select>
